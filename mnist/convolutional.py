...
def main(_, use_fp16, self_test, test_id, BATCH_SIZE, base_learning_rate, learning_decay_rate):
  if FLAGS.self_test:
  ...
  for i in range(3, 10):
    ...
    while base_learning_rate <= 0.1:
      ...
      while learning_dacay >= 0.5:
        ...
        tf.app.run(main=main, argv=[sys.argv[0], FLAGS.use_fp16, FLAGS.self_test, FLAGS.index, FLAGS.BATCH_SIZE, FLAGS.base_learning_rate, FLAGS.learning_dacay])
